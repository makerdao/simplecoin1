...
contract SimpleAuthTest is Test {
    ...
    //     //@log coin.authority():    `address coin.authority()`
    //     //@log authority:           `address authority`
    //     //@log authority.owner():   `address authority.owner()`
    //     //@log coin:                `address coin`
    //     //@log admin:               `address admin`
    // }

    function testArray() {
        bytes32[] types = bytes32[16];

        uint256 id = types.push("hola");
        //@log id:                  `uint256 id`
    }
    ...
    //     var token2 = new ERC20Base(1000);
    //     uint48 id2 = Simplecoin(admin).register(token2);
    //      //= coin.token(id);
    //     //assertEq(address(ret), address(token));
    ...
    //     //@log id:                  `uint48 id`
    //     //@log token2:               `address token2`
    //     //@log id2:                  `uint48 id2`
    //     //@log _token:              `address _token`
    //     //@log _id:                 `uint48 _id`
    // }
